...
#' @rdname W
#'
#' @description The Lambert W function \eqn{W(z) = u} is defined as the inverse
...
#'     branch solution.
#'
#' @return numeric; same dimensions/size as \code{z}.
#'
...
#'  \code{NA}. 
#' 
#' @seealso \code{\link[lamW]{lambertW0}} / \code{\link[lamW]{lambertWm1}}in the \pkg{lamW} package;
#'  \code{\link{xexp}}.
#'
